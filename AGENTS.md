# Medical News Radar Agent Notes

## Scope

This repo powers the public Medical News Radar static site and Scout Skill source workflow.
Use it for high-signal medical/healthcare news aggregation, OPML-based custom feeds,
...
- Keep the reader-facing product simple: default to a curated medical-focused view, hide noisy or advanced source details behind existing filters/docs.
...
For agent workflows, read `skills/medical-news-radar/SKILL.md`.
