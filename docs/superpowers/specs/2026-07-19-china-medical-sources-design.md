...
| `cn-chs-news` | 中国社区卫生协会 | `https://www.chs.org.cn/news/` | `static_page` / `html_list` | `primary_care` | A | 6 |
...
| `cn-medtrend` | 医趋势 | `https://medtrend.com.cn/` | `social_observation` / `html_list` | `medical_ai` | C | 4 |
...
医学界额外过滤纯病例讨论、患者用药、疾病症状和单纯诊疗指南；生物谷优先保留创新药械、产业、审批、AI 和科研转化，降低纯基础机制论文的比例。
