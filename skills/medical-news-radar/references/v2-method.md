...
Use this reference when Medical News Radar work is about product direction, source
...
1. **User**: ordinary healthcare reader, maintainer, or agent using the Skill?
...
- **Packaged variant**: makes the project easier for Codex/Claude users to fork,
  customize, and deploy as their own medical news radar.
